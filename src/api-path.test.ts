...
const TOOL_INPUTS: Record<string, unknown> = {
  ...
  list_ad_business_centers: { connection_id: UUID },
  list_ad_identities: { connection_id: UUID, ad_account_id: 'act_1' },
  list_spark_posts: { connection_id: UUID, ad_account_id: 'act_1', identity_id: 'idt_1' },
  upload_ad_conversions: {
    workspace_id: UUID,
    connection_id: UUID,
    ad_account_id: 'act_1',
    pixel_id: 'px_1',
    events: [{ event_name: 'CompletePayment', occurred_at: '2026-09-18T10:04:00Z' }],
  },
  list_ad_comments: { connection_id: UUID, ad_id: 'ad_1' },
  reply_to_ad_comment: {
    id: 'cm_1',
    workspace_id: UUID,
    connection_id: UUID,
  ...
  delete_ad_comment: { id: 'cm_1', workspace_id: UUID, connection_id: UUID, ad_id: 'ad_1' },
  list_lead_forms: {},
