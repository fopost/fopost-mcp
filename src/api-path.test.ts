...
const TOOL_INPUTS: Record<string, unknown> = {
  ...
  add_audience_companies: {
    ...
    workspace_id: UUID,
    connection_id: UUID,
    companies: [{ domain: 'northwind.example' }],
  },
  get_ad_bid_pricing: {
    workspace_id: UUID,
    connection_id: UUID,
  ...
  list_conversion_rules: { connection_id: UUID, ad_account_id: 'act_1' },
  ...
  get_conversion_rule: { id: '900', connection_id: UUID },
  update_conversion_rule: { id: '900', workspace_id: UUID, connection_id: UUID, enabled: false },
  delete_conversion_rule: { id: '900', workspace_id: UUID, connection_id: UUID },
  set_conversion_rule_ad_set: {
    id: '900',
    workspace_id: UUID,
    connection_id: UUID,
    campaign_id: '800',
  ...
  send_conversion_events: {
    ...
    workspace_id: UUID,
    connection_id: UUID,
    events: [{ happened_at: 1758326400000, email: 'buyer@yourbrand.com' }],
  },
  search_ad_library: { connection_id: UUID, keyword: 'crm', countries: ['US'] },
  estimate_ad_reach: {
    workspace_id: UUID,
    connection_id: UUID,
    ad_account_id: 'act_1',
