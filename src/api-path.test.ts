...
const TOOL_INPUTS: Record<string, unknown> = {
  ...
  list_pinterest_boards: { account_id: UUID },
  create_pinterest_board: { account_id: UUID, name: 'Recipes' },
  list_youtube_playlists: { account_id: UUID },
  create_youtube_playlist: { account_id: UUID, title: 'Tutorials' },
  set_default_youtube_playlist: { account_id: UUID, playlist_id: 'PL1' },
  list_youtube_captions: { account_id: UUID, video_id: 'v1' },
  upload_youtube_captions: { account_id: UUID, video_id: 'v1', language: 'en', body: '1\n' },
  read_youtube_transcript: { account_id: UUID, caption_id: 'cap1' },
  get_bluesky_languages: { account_id: UUID },
  set_bluesky_languages: { account_id: UUID, languages: ['en'] },
  get_tiktok_creator_info: { account_id: UUID },
  search_tiktok_music: { account_id: UUID, q: 'sunrise' },
  search_tiktok_locations: { account_id: UUID, q: 'cafe' },
  lookup_tiktok_video: {
    account_id: UUID,
    url: 'https://www.tiktok.com/@a/video/7300000000000000000',
  },
  search_instagram_audio: { account_id: UUID },
  get_instagram_publishing_limit: { account_id: UUID },
  list_instagram_stories: { account_id: UUID },
  get_instagram_story_insights: { account_id: UUID, story_id: 's1' },
  search_linkedin_mentions: { account_id: UUID, q: 'devtestco' },
